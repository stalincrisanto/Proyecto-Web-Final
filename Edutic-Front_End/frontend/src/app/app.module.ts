...
import { UserAdministrativoComponent } from './user-administrativo/user-administrativo.component';
...
@NgModule({
    ...
    providers: [
        ...
        MessageService, CarService, CountryService, EventService, NodeService, BreadcrumbService, MenuService, ProductoService, InfraestructuraService, LoginService, DocenteService,EstudianteService
    ],
